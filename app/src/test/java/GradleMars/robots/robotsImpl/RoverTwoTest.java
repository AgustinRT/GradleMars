...
public class RoverTwoTest {
    ...
    public void testHappyPath() {
        ...
        System.setOut(ps);
        RoverTwo robotTest = new RoverTwo(new Scanner(System.in));
    ...
    public void testRoverRepot() {
        ...
        int responseSize = listOoutputs.length;
        String sampleCleanLine = listOoutputs[(responseSize - 9)].trim();
        String roverCurrentPosLine = listOoutputs[(responseSize - 7)].trim();
        String roverOldPosLine = listOoutputs[(responseSize - 6)].trim();
        assertEquals(sampleCleanLine, "|          |");
        assertEquals(roverCurrentPosLine, "|     ^    |");
        assertEquals(roverOldPosLine, "|     ·    |");
        ...
        outputText = byteArrayOutputStream.toString();
        listOoutputs = outputText.split("\n");
        responseSize = listOoutputs.length;
        sampleCleanLine = listOoutputs[(responseSize - 9)].trim();
        roverCurrentPosLine = listOoutputs[(responseSize - 7)].trim();
        roverOldPosLine = listOoutputs[(responseSize - 6)].trim();
        assertEquals(sampleCleanLine, "|          |");
        assertEquals(roverCurrentPosLine, "|     >    |");
        assertEquals(roverOldPosLine, "|     ·    |");
    ...
    public void testRoverObstaclesBloquing() {
        ...
        int responseSize = listOoutputs.length;
        String sampleCleanLine = listOoutputs[(responseSize - 8)].trim();
        String roverCurrentPosLine = listOoutputs[(responseSize - 7)].trim();
        String roverOldPosLine = listOoutputs[(responseSize - 6)].trim();
        assertEquals(sampleCleanLine, "|     *    |");
        assertEquals(roverCurrentPosLine, "|     ^    |");
        assertEquals(roverOldPosLine, "|     ·    |");
        lastMessage = listOoutputs[(listOoutputs.length - 13)].trim();
